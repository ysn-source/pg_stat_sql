...
SET pg_stat_statements.track_every = TRUE;
...
SELECT query, start, rows FROM pg_stat_sql ORDER BY start DESC;
...
-- SELECT pg_stat_sql before and after pg_stat_statements_reset();

SELECT count(*) before_stmts_reset FROM pg_stat_sql;
SELECT pg_stat_statements_reset();
SELECT count(*) after_stmts_reset FROM pg_stat_sql;
SELECT pg_stat_sql_reset();
...
--
-- pg_stat_statements.track_every = none
--
SET pg_stat_statements.track_every = FALSE;
SELECT pg_stat_sql_reset();
